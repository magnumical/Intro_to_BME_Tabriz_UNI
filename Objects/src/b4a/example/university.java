...
public class university extends Activity implements B4AActivity{
	public static university mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.university");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (university).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.university");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.university", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (university) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (university) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (university) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
int _i = 0;
 ...
 //BA.debugLineNum = 17;BA.debugLine="Activity.LoadLayout (\"Loader\")";
mostCurrent._activity.LoadLayout("Loader",mostCurrent.activityBA);
...
_s = "";
 //BA.debugLineNum = 29;BA.debugLine="cur = db.execquery(\"SELECT * FROM unive\")";
_cur.setObject((android.database.Cursor)(_db.ExecQuery("SELECT * FROM unive")));
...
_s = _s+_cur.GetString("Text");
 ...
 //BA.debugLineNum = 36;BA.debugLine="s = s&cur.GetString(\"Text\")&\"<img>im\"&i&\".png</";
_s = _s+_cur.GetString("Text")+"<img>im"+BA.NumberToString(_i)+".png</img>";
 };
 }
};
...
anywheresoftware.b4a.objects.StringUtils _su = null;
 //BA.debugLineNum = 59;BA.debugLine="Sub ImgToText(sv As ScrollView,str As String)";
 //BA.debugLineNum = 60;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 61;BA.debugLine="Dim img As ImageView";
_img = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 62;BA.debugLine="Dim s,s2 As String";
_s = "";
_s2 = "";
 //BA.debugLineNum = 63;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 64;BA.debugLine="Dim bmp As Bitmap";
_bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 65;BA.debugLine="Dim su As StringUtils";
_su = new anywheresoftware.b4a.objects.StringUtils();
 //BA.debugLineNum = 66;BA.debugLine="p = sv.Panel";
_p = _sv.getPanel();
 //BA.debugLineNum = 67;BA.debugLine="p.Height = 0";
_p.setHeight((int) (0));
 //BA.debugLineNum = 69;BA.debugLine="Do While str.Length > 0";
while (_str.length()>0) {
 //BA.debugLineNum = 71;BA.debugLine="If str.StartsWith(\"<img>\") Then";
if (_str.startsWith("<img>")) { 
 //BA.debugLineNum = 72;BA.debugLine="s = \"img\"";
_s = "img";
 }else {
 //BA.debugLineNum = 74;BA.debugLine="s = \"lbl\"";
_s = "lbl";
 };
 //BA.debugLineNum = 77;BA.debugLine="Select s";
switch (BA.switchObjectToInt(_s,"img","lbl")) {
case 0: {
 //BA.debugLineNum = 80;BA.debugLine="s2 = str.SubString2(str.IndexOf(\"<img>\") + 5,s";
_s2 = _str.substring((int) (_str.indexOf("<img>")+5),_str.indexOf("</img>"));
 //BA.debugLineNum = 81;BA.debugLine="str = str.SubString(str.IndexOf(\"</img>\") + 6)";
_str = _str.substring((int) (_str.indexOf("</img>")+6));
 //BA.debugLineNum = 82;BA.debugLine="bmp.Initialize(File.DirAssets,s2)";
_bmp.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),_s2);
 //BA.debugLineNum = 83;BA.debugLine="img.Initialize(\"img\")";
_img.Initialize(mostCurrent.activityBA,"img");
 //BA.debugLineNum = 84;BA.debugLine="img.Bitmap = bmp";
_img.setBitmap((android.graphics.Bitmap)(_bmp.getObject()));
 //BA.debugLineNum = 85;BA.debugLine="p.AddView(img,0,p.Height,bmp.Width,bmp.Height)";
_p.AddView((android.view.View)(_img.getObject()),(int) (0),_p.getHeight(),_bmp.getWidth(),_bmp.getHeight());
 //BA.debugLineNum = 87;BA.debugLine="img.Height = img.Height * (sv.Width - sv.Left)";
_img.setHeight((int) (_img.getHeight()*(_sv.getWidth()-_sv.getLeft())));
 //BA.debugLineNum = 88;BA.debugLine="img.Height = img.Height / img.Width";
_img.setHeight((int) (_img.getHeight()/(double)_img.getWidth()));
 //BA.debugLineNum = 89;BA.debugLine="img.Width = sv.Width - sv.Left";
_img.setWidth((int) (_sv.getWidth()-_sv.getLeft()));
 //BA.debugLineNum = 92;BA.debugLine="img.Gravity = Gravity.CENTER_VERTICAL";
_img.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL);
 //BA.debugLineNum = 93;BA.debugLine="img.Gravity = Gravity.FILL";
_img.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 95;BA.debugLine="p.Height = p.Height + img.Height";
_p.setHeight((int) (_p.getHeight()+_img.getHeight()));
 break; }
case 1: {
 //BA.debugLineNum = 97;BA.debugLine="If str.Contains(\"<img>\") Then";
if (_str.contains("<img>")) { 
 //BA.debugLineNum = 98;BA.debugLine="s2 = str.SubString2(0,str.IndexOf(\"<img>\"))";
_s2 = _str.substring((int) (0),_str.indexOf("<img>"));
 //BA.debugLineNum = 99;BA.debugLine="str = str.SubString(str.IndexOf(\"<img>\"))";
_str = _str.substring(_str.indexOf("<img>"));
 //BA.debugLineNum = 100;BA.debugLine="str = str.SubString(str.IndexOf(\"<img>\"))";
_str = _str.substring(_str.indexOf("<img>"));
 }else {
 //BA.debugLineNum = 102;BA.debugLine="s2 = str";
_s2 = _str;
 //BA.debugLineNum = 103;BA.debugLine="str = str.SubString(str.Length)";
_str = _str.substring(_str.length());
 //BA.debugLineNum = 104;BA.debugLine="s = \"\"";
_s = "";
 };
 //BA.debugLineNum = 106;BA.debugLine="lbl.Initialize(\"lbl\")";
_lbl.Initialize(mostCurrent.activityBA,"lbl");
 //BA.debugLineNum = 107;BA.debugLine="lbl.Text = s2";
_lbl.setText(BA.ObjectToCharSequence(_s2));
 //BA.debugLineNum = 108;BA.debugLine="p.AddView(lbl,sv.Left,p.Height,sv.Width - sv.L";
_p.AddView((android.view.View)(_lbl.getObject()),_sv.getLeft(),_p.getHeight(),(int) (_sv.getWidth()-_sv.getLeft()),(int) (0));
 //BA.debugLineNum = 112;BA.debugLine="lbl.TextColor = Colors.White";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 113;BA.debugLine="lbl.Gravity = Gravity.RIGHT";
_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.RIGHT);
 //BA.debugLineNum = 114;BA.debugLine="lbl.TextSize=20";
_lbl.setTextSize((float) (20));
 //BA.debugLineNum = 115;BA.debugLine="lbl.Height = su.MeasureMultilineTextHeight(lbl";
_lbl.setHeight(_su.MeasureMultilineTextHeight((android.widget.TextView)(_lbl.getObject()),_s2));
 //BA.debugLineNum = 116;BA.debugLine="p.Height = p.Height + lbl.Height";
