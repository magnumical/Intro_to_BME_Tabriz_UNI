...
public class moghaddame extends Activity implements B4AActivity{
	public static moghaddame mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.moghaddame");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (moghaddame).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.moghaddame");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.moghaddame", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (moghaddame) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (moghaddame) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (moghaddame) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
int _i = 0;
 ...
 //BA.debugLineNum = 18;BA.debugLine="Activity.LoadLayout (\"l_moghaddame\")";
mostCurrent._activity.LoadLayout("l_moghaddame",mostCurrent.activityBA);
...
_s = "";
 //BA.debugLineNum = 29;BA.debugLine="cur = db.execquery(\"SELECT * FROM biom\")";
_cur.setObject((android.database.Cursor)(_db.ExecQuery("SELECT * FROM biom")));
...
_s = _s+_cur.GetString("Text");
 ...
 //BA.debugLineNum = 36;BA.debugLine="s = s&cur.GetString(\"Text\")&\"<img>ab\"&i&\".png</";
_s = _s+_cur.GetString("Text")+"<img>ab"+BA.NumberToString(_i)+".png</img>";
 };
 }
};
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 12;BA.debugLine="Private title As Label";
mostCurrent._title = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 13;BA.debugLine="Private scroller As ScrollView";
...
_lbl.setTextSize((float) (20));
 //BA.debugLineNum = 118;BA.debugLine="lbl.Height = su.MeasureMultilineTextHeight(lbl";
_lbl.setHeight(_su.MeasureMultilineTextHeight((android.widget.TextView)(_lbl.getObject()),_s2));
 //BA.debugLineNum = 119;BA.debugLine="p.Height = p.Height + lbl.Height";
